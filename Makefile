...
REGISTRY=tutorial.com/golang
SYSTEMNS=tutorial/app/io/web/api/system
...
lookup-var:			## Lookup for variable link name
	...
	go tool nm ./tutorial | grep $$name

project: 			## Create new project
	@read -p "Enter project name: " name; \
	rsync -av --progress . ../$$name --exclude vendor --exclude tutorial --exclude swagger --exclude .idea --exclude .git; \
	find ../$$name tutorial -path ./vendor -prune -o -path ./.idea -prune -o -path ./.git -prune -o -print -type f -exec sed -i '' -e "s/tutorial/$$name/g" {} \;
